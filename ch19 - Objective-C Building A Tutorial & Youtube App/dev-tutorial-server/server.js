...
app.all('/*', function(req, res, next){
  ...
  res.header('Access-Controll-Allow-Hearders', 'X-Requested-With', 'Content-Type', 'Accept');
...
var comments = [
  {
  username: "jack942",
  comment: "This video was really cool. Any change you could drop what you are doing and code my problem for me?"
}
];

app.post('/comments', function(res, res) {
